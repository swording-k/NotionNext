...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Skyler Yang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'AI 产品经理 / AI 应用工程师，记录 AI 产品思考、项目复盘和个人 IP 搭建过程。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://swording-k.github.io', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI产品,个人IP,NotionNext,产品复盘,作品集,AI应用开发', // 网站关键词 英文逗号隔开
